            ...
            this.contractCallbacks.set(contractId, contract => {
                ...
                if (contract.is_sold || contract.is_expired || contract.status !== 'open') {
                    ...
                    resolve({
                        ...
                        entry_digit: contract.entry_spot
                            ? extractLastDigit(contract.entry_spot, contract.underlying)
                            : undefined,
                        exit_digit: contract.exit_spot
                            ? extractLastDigit(contract.exit_spot, contract.underlying)
                            : undefined,
                    });
