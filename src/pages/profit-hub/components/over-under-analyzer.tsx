    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        ...
        {signal === "TRADE" || signal === "STRONG" ? (
          <Button
            size="lg"
            className={`px-8 py-4 text-lg font-bold text-white animate-pulse ${signalColor === "green"
      ...
      <motion.div
        ...
        className={`rounded-xl p-6 border text-center ${signal === "STRONG"
      ...
      >
        <Badge
          className={`text-2xl px-8 py-4 font-bold mb-4 ${signal === "STRONG"
        ...
        >
          ...
          <div className="flex flex-wrap gap-2">
            {prediction.split(", ").map((pred, idx) => (
              <Badge
                key={idx}
                className={`px-4 py-2 text-base font-semibold ${theme === "dark"
      ...
      {signal === "TRADE" || signal === "STRONG" ? (
        ...
        >
          <Button
            size="lg"
            className={`w-full px-8 py-6 text-xl font-bold text-white animate-pulse ${dominantSide === "OVER"
