        ...
        <div className='fixed inset-0 z-50 flex items-center justify-center p-4 overflow-hidden'>
            ...
            <div className='relative w-full max-w-lg sm:max-w-xl z-10'>
                    ...
                    <div className='space-y-2 sm:space-y-3'>
                        {steps.map(step => (
                            ...
                            >
                                ...
                                {step.status === 'loading' && (
                                    <span className='text-xs text-emerald-400 font-semibold animate-pulse flex-shrink-0'>
                                        Loading...
                                    </span>
                                )}
                                {step.status === 'complete' && (
                ...
                <div className='glass-frost rounded-2xl p-3 sm:p-4 mb-4'>
                    <h3 className='text-sm sm:text-base font-bold text-white mb-2 sm:mb-3 text-center'>
                        Contact & Support
                    </h3>
