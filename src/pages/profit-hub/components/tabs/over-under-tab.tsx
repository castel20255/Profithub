...
import { OverUnderAnalyzer } from "@/profit-hub/components/over-under-analyzer"
import { Badge } from "@/profit-hub/components/ui/badge"
import { LastDigitsChart } from "@/profit-hub/components/last-digits-chart"
import { LastDigitsLineChart } from "@/profit-hub/components/last-digits-line-chart"

interface OverUnderTabProps {
  theme?: "light" | "dark"
}

export function OverUnderTab({ theme = "dark" }: OverUnderTabProps) {
