...
export function DeepStatisticalAnalysisTab({ theme = 'dark' }: DeepStatisticalAnalysisTabProps) {
    ...
    const analyzeDigits = useCallback(() => {
        ...
        const evenOddBalance = {
            ...
            bias:
                Math.abs(evenCount - oddCount) < digits.length * 0.1
                    ? 'BALANCED'
                    : evenCount > oddCount
                      ? 'EVEN'
                      : 'ODD',
        ...
        <div className='space-y-6 pb-8'>
            ...
            {analysisResult && (
                <Tabs defaultValue='overview' className='w-full'>
                    <TabsList
                        className={`grid w-full grid-cols-4 ${theme === 'dark' ? 'bg-[#0f1629]' : 'bg-gray-100'}`}
                    >
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                                ...
                                <div className='space-y-3'>
                                    ...
                                    <Badge
                                        className={`w-full justify-center ${
                                            analysisResult.evenOddBalance.bias === 'BALANCED'
                                                ? 'bg-green-500'
                                                : 'bg-orange-500'
                                        }`}
                                    >
                            ...
                            >
                                ...
                                <div className='space-y-3'>
                                    ...
                                    <Badge
                                        className={`w-full justify-center ${
                                            analysisResult.overUnderBalance.bias === 'BALANCED'
                                                ? 'bg-green-500'
                                                : 'bg-orange-500'
                                        }`}
                                    >
                        ...
                        >
                            ...
                            >
                                <div className='text-center'>
                                    ...
                                    <div
                                        className={`text-5xl font-bold ${theme === 'dark' ? 'text-green-400' : 'text-green-600'}`}
                                    >
                                        {analysisResult.marketFavorability.overallScore.toFixed(1)}
                                    </div>
                                    <Progress
                                        value={analysisResult.marketFavorability.overallScore}
                                        className='h-3 mt-4'
                                    />
                                </div>
                            </Card>
