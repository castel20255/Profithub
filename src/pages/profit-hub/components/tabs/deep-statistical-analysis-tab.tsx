...
import { DerivAPIClient } from "@/profit-hub/lib/deriv-api"
import { DERIV_MARKETS } from "@/profit-hub/lib/deriv-markets"
import { Button } from "@/profit-hub/components/ui/button"
import { Badge } from "@/profit-hub/components/ui/badge"
import { Progress } from "@/profit-hub/components/ui/progress"
import { Card, CardContent, CardHeader, CardTitle } from "@/profit-hub/components/ui/card"
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/profit-hub/components/ui/tabs"
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/profit-hub/components/ui/select"
import { AlertCircle, TrendingUp, TrendingDown, Activity, BarChart3, PieChart, Zap } from "lucide-react"
...
export function DeepStatisticalAnalysisTab({ theme = "dark" }: DeepStatisticalAnalysisTabProps) {
  ...
  return (
    <div className="space-y-6 pb-8">
      ...
      >
        <h2
          className={`text-2xl md:text-3xl font-bold mb-4 text-center ${theme === "dark"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <Badge
                    className={`w-full justify-center ${analysisResult.evenOddBalance.bias === "BALANCED" ? "bg-green-500" : "bg-orange-500"
                      }`}
                  >
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <Badge
                    className={`w-full justify-center ${analysisResult.overUnderBalance.bias === "BALANCED" ? "bg-green-500" : "bg-orange-500"
                      }`}
                  >
                ...
                {analysisResult.patterns.map((pattern, idx) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <Badge
                        className={`${pattern.confidence >= 70
                          ? "bg-green-500"
          ...
          <TabsContent value="favorability" className="space-y-4 mt-4">
            ...
            >
              ...
              <div className="text-center mb-6">
                <Badge
                  className={`text-lg px-6 py-2 ${analysisResult.marketFavorability.recommendation === "HIGHLY FAVORABLE"
