                        ...
                        if (isWin) {
                            ...
                            if (martingaleStepRef.current < formState.maxMartingaleSteps) {
                                currentStakeRef.current = Number(
                                    (currentStakeRef.current * formState.martingaleMultiplier).toFixed(2)
                                );
                            } else {
        ...
        <div className='min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 p-4'>
            <div className='max-w-7xl mx-auto'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-3 gap-4'>
                    ...
                    <Card
                        className={`lg:col-span-2 bg-slate-800/50 border-slate-700 ${!showConfig ? 'hidden lg:block' : ''}`}
                    >
                        <CardHeader>
                        ...
                        <CardContent className='space-y-4'>
                            ...
                            <div className='grid grid-cols-2 gap-4'>
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        onChange={e =>
                                            setFormState({ ...formState, prediction: Number(e.target.value) })
                                        }
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={e =>
                                            setFormState({ ...formState, takeProfit: Number(e.target.value) })
                                        }
                                    />
                                </div>
                                ...
                                <div className='flex items-center justify-between'>
                                    ...
                                    <Switch
                                        ...
                                        onCheckedChange={checked =>
                                            setFormState({ ...formState, enableMartingale: checked })
                                        }
                                    />
                                </div>
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={e =>
                                                    setFormState({
                                                        ...formState,
                                                        maxMartingaleSteps: Number(e.target.value),
                                                    })
                                                }
                                            />
                                        </div>
                            ...
                            {isRunning && (
                                <div className='p-3 bg-green-500/20 border border-green-500/50 rounded-lg flex items-center gap-2'>
                                    ...
                                    {isAwaitingResult && (
                                        <span className='text-yellow-400 ml-2'>(Waiting for result...)</span>
                                    )}
                                </div>
                            )}
                            ...
                            <div className='grid grid-cols-4 gap-4 p-4 bg-slate-700/30 rounded-lg'>
                                ...
                                <div>
                                    ...
                                    <div
                                        className={`text-lg font-semibold ${totalPL >= 0 ? 'text-green-400' : 'text-red-400'}`}
                                    >
                                        ${totalPL.toFixed(2)}
                                    </div>
                                </div>
