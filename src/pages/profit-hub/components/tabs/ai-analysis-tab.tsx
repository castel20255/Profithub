        ...
        const strategies = [
            {
                ...
                signal:
                    (analysis.lowPercentage || 0) >= 60
                        ? 'UNDER 4'
                        : (analysis.highPercentage || 0) >= 60
                          ? 'OVER 5'
                          : 'NEUTRAL',
            ...
            },
            {
                ...
                signal:
                    (analysis.evenPercentage || 0) >= 60
                        ? 'EVEN'
                        : (analysis.oddPercentage || 0) >= 60
                          ? 'ODD'
                          : 'NEUTRAL',
            ...
            },
            {
                ...
                confidence:
                    safeDigitFrequencies.length > 0
                        ? 100 -
                          ([...safeDigitFrequencies].sort((a, b) => a.percentage - b.percentage)[0]?.percentage || 10)
                        : 50,
                signal: 'DIFFERS',
                entryPoint:
                    safeDigitFrequencies.length > 0
        ...
        <div className='space-y-6 pb-[200px]'>
            ...
            >
                <p className={`text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>
                    To execute trades based on AI signals, use the{' '}
                    <span className='font-semibold text-cyan-400'>Slider</span> or{' '}
