"use client"
// ProfitHub Even/Odd Tab Component

import { useState, useEffect } from "react"
import { Badge } from "@/profit-hub/components/ui/badge"
import { Button } from "@/profit-hub/components/ui/button"
import { LastDigitsDisplay } from "@/profit-hub/components/last-digits-display"
import type { Signal, AnalysisResult } from "@/profit-hub/lib/analysis-engine"
...
export function EvenOddTab({ theme = "dark" }: EvenOddTabProps) {
  const { analysis, signals, currentDigit, currentPrice, recentDigits } = useDeriv()
  ...
  return (
    <div className="space-y-6">
      <div
        className={`rounded-xl p-4 border text-center ${theme === "dark"
      ...
      >
        ...
        {currentDigit !== null ? (
          <div
            className={`text-4xl font-bold animate-pulse ${theme === "dark"
