                    ...
                    <CardContent>
                        <div className='grid grid-cols-3 gap-4'>
                            ...
                            <div>
                                ...
                                <p
                                    className={`text-lg font-bold ${theme === 'dark' ? 'text-cyan-400' : 'text-blue-600'}`}
                                >
                ...
                <Card className={theme === 'dark' ? 'bg-slate-800/50 border-slate-700' : 'bg-white border-gray-200'}>
                    ...
                    <CardContent>
                        <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
                            <div>
                                <label
                                    className={`text-sm mb-1 block ${theme === 'dark' ? 'text-slate-300' : 'text-gray-700'}`}
                                >
                                    Initial Stake ($)
                                </label>
                                <input
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={e =>
                                        setConfig({ ...config, martingaleMultiplier: Number(e.target.value) })
                                    }
                                    disabled={isRunning}
                                />
                            </div>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                            {BOT_STRATEGIES.map(strategy => (
                                ...
                                >
                                    ...
                                    <CardContent>
                                        <p
                                            className={`text-sm mb-4 ${theme === 'dark' ? 'text-slate-300' : 'text-gray-600'}`}
                                        >
                            ...
                            >
                                ...
                                <CardContent>
                                    <div className='grid grid-cols-4 gap-4'>
                                        <div
                                            className={`p-4 rounded-lg ${theme === 'dark' ? 'bg-slate-700/30' : 'bg-gray-100'}`}
                                        >
                                            <div
