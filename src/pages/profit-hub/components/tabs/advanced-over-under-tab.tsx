  ...
  return (
    <div className="space-y-6 p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Under 4 Analysis */}
        <Card
          className={`border-2 ${analysis.under4.signal.status === "STRONG" || analysis.under4.signal.status === "TRADE NOW"
            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-2">
                {analysis.under4.frequencies.map((f) => (
                  <div
                    key={f.digit}
                    className={`p-2 rounded text-center ${f.digit === analysis.under4.highest.digit
        ...
        {/* Over 5 Analysis */}
        <Card
          className={`border-2 ${analysis.over5.signal.status === "STRONG" || analysis.over5.signal.status === "TRADE NOW"
            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-2">
                {analysis.over5.frequencies.map((f) => (
                  <div
                    key={f.digit}
                    className={`p-2 rounded text-center ${f.digit === analysis.over5.highest.digit
        ...
        <CardContent>
          <div className="grid grid-cols-5 sm:grid-cols-10 gap-2">
            {analysis.allDigits.map((f) => (
              <div
                key={f.digit}
                className={`p-2 sm:p-3 rounded text-center transition-all ${f.digit <= 3
              ...
              >
                <div
                  className={`text-lg sm:text-xl font-bold ${f.digit <= 3
                    ? "text-blue-400"
                    : f.digit >= 6
                      ? "text-green-400"
                      : theme === "dark"
