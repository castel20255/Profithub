...
export function MatchesTab({ theme = "dark" }: MatchesTabProps) {
  const { signals, analysis, recentDigits } = useDeriv()
    ...
    <div className="space-y-6">
      ...
      >
        ...
        {matchesSignal && (
          ...
          >
            <Badge
              className={`text-lg px-4 py-2 mb-4 ${matchesSignal.status === "TRADE NOW"
                ? theme === "dark"
