            ...
            >
                ...
                <div className='p-4 space-y-4 flex-1 overflow-y-auto'>
                    <Tabs value={activeTab} onValueChange={setActiveTab}>
                        <TabsList
                            className={`grid w-full grid-cols-5 ${theme === 'dark' ? 'bg-[#0f1629]/50' : 'bg-gray-100'}`}
                        >
                        ...
                        <TabsContent value='manual' className='space-y-3 mt-4'>
                            <div className='space-y-2'>
                                <div className='grid grid-cols-2 gap-2'>
                                    <div>
                                        <Label
                                            className={`text-xs mb-1.5 block ${theme === 'dark' ? 'text-cyan-400' : 'text-blue-600'}`}
                                        >
                                            Market
                                        </Label>
                                ...
                                <div>
                                    ...
                                    <Select value={manualContract} onValueChange={setManualContract}>
                                        ...
                                        <SelectContent>
                                            {(
                                                TRADE_TYPES[manualTradeType as keyof typeof TRADE_TYPES]?.contracts ||
                                                []
                                            ).map(c => (
                            ...
                            >
                                <div className='grid grid-cols-2 gap-3 text-xs'>
                                    <div>
                                        ...
                                        <div
                                            className={`font-bold text-lg ${theme === 'dark' ? 'text-emerald-400' : 'text-emerald-600'}`}
                                        >
                                    ...
                                    <div>
                                        ...
                                        <div
                                            className={`font-bold text-lg ${theme === 'dark' ? 'text-cyan-400' : 'text-cyan-600'}`}
                                        >
                            ...
                            <div className='space-y-2'>
                                <div className='grid grid-cols-2 gap-2'>
                                    <div>
                                        ...
                                        <Select
                                            value={autorunMarket}
                                            onValueChange={setAutorunMarket}
                                    ...
                                    <div>
                                        ...
                                        <Select
                                            value={autorunTradeType}
                                            onValueChange={setAutorunTradeType}
                                            disabled={autorunRunning}
                                        >
                                            <SelectTrigger
                                                className={`text-xs ${theme === 'dark' ? 'bg-[#0f1629] border-blue-500/30 text-white' : ''}`}
                                ...
                                <div>
                                    ...
                                    <Select
                                        value={autorunContract}
                                        onValueChange={setAutorunContract}
                                        disabled={autorunRunning}
                                    >
                                        <SelectTrigger
                                            className={`text-xs ${theme === 'dark' ? 'bg-[#0f1629] border-blue-500/30 text-white' : ''}`}
                                        ...
                                        <SelectContent>
                                            {(
                                                TRADE_TYPES[autorunTradeType as keyof typeof TRADE_TYPES]?.contracts ||
                                                []
                                            ).map(c => (
                                                <SelectItem key={c} value={c}>
                                                    {c}
                                ...
                                <div className='grid grid-cols-2 gap-2'>
                                    ...
                                    <div>
                                        <Label
                                            className={`text-xs mb-1.5 block ${theme === 'dark' ? 'text-red-400' : 'text-red-600'}`}
                                        >
                                            Margin
                                        </Label>
                                        <Input
                            ...
                            <div className='space-y-2'>
                                <div className='grid grid-cols-2 gap-2'>
                                    <div>
                                        ...
                                        <Select
                                            value={speedbotMarket}
                                            onValueChange={setSpeedbotMarket}
                                    ...
                                    <div>
                                        ...
                                        <Select
                                            value={speedbotTradeType}
                                            onValueChange={setSpeedbotTradeType}
                                            disabled={speedbotRunning}
                                        >
                                            <SelectTrigger
                                                className={`text-xs ${theme === 'dark' ? 'bg-[#0f1629] border-blue-500/30 text-white' : ''}`}
                                ...
                                <div>
                                    ...
                                    <Select
                                        value={speedbotContract}
                                        onValueChange={setSpeedbotContract}
                                        disabled={speedbotRunning}
                                    >
                                        <SelectTrigger
                                            className={`text-xs ${theme === 'dark' ? 'bg-[#0f1629] border-blue-500/30 text-white' : ''}`}
                                        ...
                                        <SelectContent>
                                            {(
                                                TRADE_TYPES[speedbotTradeType as keyof typeof TRADE_TYPES]?.contracts ||
                                                []
                                            ).map(c => (
                                                <SelectItem key={c} value={c}>
                                                    {c}
                            ...
                            <Card className={`p-3 ${theme === 'dark' ? 'bg-[#0f1629]/50' : 'bg-gray-50'}`}>
                                <div className='grid grid-cols-3 gap-2 text-xs'>
                                    <div>
                                        ...
                                        <div
                                            className={`font-bold ${theme === 'dark' ? 'text-red-400' : 'text-red-600'}`}
                                        >
                                            {totalStake > 0
                                                ? ((contractsLost / transactions.length) * 100).toFixed(0)
                                                : 0}
                                            %
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        >
                                            {totalStake > 0
                                                ? ((contractsWon / transactions.length) * 100).toFixed(0)
                                                : 0}
                                            %
                                        </div>
                                    </div>
