...
import {
    ...
    AlertDialogHeader,
    AlertDialogTitle,
} from '@/profit-hub/components/ui/alert-dialog';
                ...
                <AlertDialogContent className={theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-white'}>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription className={theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}>
                            Are you sure you want to switch to account {pendingSwitchAccount}? This will disconnect your
                            current session.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
            ...
            {isLoggedIn && (
                <div className='flex items-center space-x-2 sm:space-x-3'>
                    ...
                    >
                        ...
                        <div className='flex items-center gap-1.5'>
                            ...
                            <a
                                ...
                                className={`text-xs sm:text-sm font-mono font-semibold flex items-center gap-1 hover:underline cursor-pointer transition-colors ${
                                    theme === 'dark'
                    ...
                    <Button
                        onClick={logout}
                        size='sm'
                        className='bg-red-600 hover:bg-red-700 text-white text-xs sm:text-sm h-9'
                    >
